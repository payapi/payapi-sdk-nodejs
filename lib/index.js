(function () {
  ...
  var InputDataValidator = require("./validators").InputDataValidator;
  var apiKey;
  var secret;
  var payment;
  var consumer;
  ...
  module.exports = function PayapiClient(params) {
    ...
    function validatePayload(params) {
      return new Promise(function(resolve, reject) {
        ...
        console.log('CLIENT: validationErrors.length:' + validationErrors.length);
        if(validationErrors.length > 0) {
          console.log('CLIENT:' + validationErrors.length + ' validation errors found.');
          reject(validationErrors);
        } else {
          console.log('CLIENT: No validation errors found.');
