(function () {
  ...
  exports.InputDataValidator = function(params) {
    ...
    function validateOrder(order) {
      if(!validator.isInt(order.sumInCentsIncVat + "", { min: 0, max: Number.MAX_SAFE_INTEGER })) {
        validationErrors.push({
      ...
      if(!validator.isInt(order.sumInCentsExcVat + "", { min: 0, max: Number.MAX_SAFE_INTEGER })) {
        validationErrors.push({
      ...
      if(!validator.isInt(order.vatInCents + "", { min: 0, max: Number.MAX_SAFE_INTEGER })) {
        validationErrors.push({
