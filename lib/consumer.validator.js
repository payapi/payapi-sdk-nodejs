      ...
      function validatePhoneNumber() {
        ...
        if (!consumer.mobilePhoneNumber && isOptional("mobilePhoneNumber")) {
          ...
          if (consumer.mobilePhoneNumber) {
            if (mobilePhoneNumber.length < 9 || mobilePhoneNumber.length > 16) {
              validationErrors.push({
                value: "Consumer mobile phone number must be between 9 and 16 characters",
            ...
            } else if (mobilePhoneNumber.match(BLACKLISTED_CHARACTERS)) {
              validationErrors.push({
