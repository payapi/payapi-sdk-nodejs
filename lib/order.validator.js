  ...
  var OrderValidator = (function() {
    var OrderValidator = function(params) {
      ...
      function validateSumInCentsIncVat() {
        if(!isNaN(order.sumInCentsIncVat) && order.sumInCentsIncVat >= 0) {
          validateCents({
      ...
      function validateSumInCentsExcVat() {
        if(!isNaN(order.sumInCentsExcVat) && order.sumInCentsExcVat >= 0) {
          validateCents({
      ...
      function validateVatInCents() {
        if(!isNaN(order.vatInCents) && order.vatInCents >= 0) {
          validateCents({
